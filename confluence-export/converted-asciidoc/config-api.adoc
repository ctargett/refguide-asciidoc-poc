...
For more information about user-defined properties, see the section <<configuring-solrconfig-xml.adoc#Configuringsolrconfig.xml-Userdefinedpropertiesfromcore.properties,User defined properties from core.properties>>. See also the section link:REL_LINK//#ConfigAPI-CreatingandUpdatingUser-DefinedProperties[Creating and Updating User-Defined Properties] below for examples of how to use this type of command.
