...
We can begin with "`text_ws`" - one of the most simplified Text field types available: image::images/running-your-analyzer/analysis_compare_0.png[image]
...
For our next attempt, let's try the "`text_general`" field type: image::images/running-your-analyzer/analysis_compare_1.png[image]
