...
We can begin with "`text_ws`" - one of the most simplified Text field types available: image::attachments/32604241/51183922.png[image]
...
For our next attempt, let's try the "`text_general`" field type: image::attachments/32604241/51183923.png[image]
...
image::attachments/32604241/51183924.png[image]
