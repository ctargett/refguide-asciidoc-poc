...
|useDocValuesAsStored |If the field has <<docvalues.adoc#,docValues>> enabled, setting this to true would allow the field to be returned as if it were a stored field (even if it has `stored=false`) when matching "`*`" in an <<common-query-parameters.adoc#CommonQueryParameters-Thefl(FieldList)Parameter,fl parameter>>. |true or false |true
|=========================================================================================================================================================================================================================================================================================================================================================================================================================================================================
