...
This option will only add or overwrite documents to the index; for other update tasks, see the link:#DocumentsScreen-SolrCommand[Solr Command] option.
...
* link:uploading-data-with-index-handlers.html[Uploading Data with Index Handlers]
* link:uploading-data-with-solr-cell-using-apache-tika.html[Uploading Data with Solr Cell using Apache Tika]
