...
For more information about relevance, see Grant Ingersoll's tech article http://searchhub.org/2009/09/02/debugging-search-application-relevance-issues/[Debugging Search Application Relevance Issues] which is available on SearchHub.org.
