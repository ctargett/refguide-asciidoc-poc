...
Real Time Get requests can also be combined with filter queries, specified with an link:common-query-parameters.html#CommonQueryParameters-Thefq(FilterQuery)Parameter[`fq` parameter], just like search requests:
