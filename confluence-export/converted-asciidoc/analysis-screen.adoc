...
The section link:understanding-analyzers-tokenizers-and-filters.html[Understanding Analyzers, Tokenizers, and Filters] describes in detail what each option is and how it may transform your data and the section link:running-your-analyzer.html[Running Your Analyzer] has specific examples for using the Analysis screen.
