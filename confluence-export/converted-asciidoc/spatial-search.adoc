...
Using the <<the-dismax-query-parser.adoc,DisMax>> or link:REL_LINK//the-extended-dismax-query-parser.adoc[Extended DisMax], you can combine spatial search with the boost function to boost the nearest results:
