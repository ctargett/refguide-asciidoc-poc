...
The Stream screen allows you to enter a link:streaming-expressions.html[streaming expression] and see the results. It is very similar to the link:query-screen.html[Query Screen], except the input box is at the top and all options must be declared in the expression.
