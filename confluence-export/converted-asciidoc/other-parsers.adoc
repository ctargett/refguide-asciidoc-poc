...
For easy filter construction to drill down in faceting, the <<#OtherParsers-TermQueryParser,TermQParserPlugin>> is recommended. For full analysis on all fields, including text fields, you may want to use the link:REL_LINK//#OtherParsers-FieldQueryParser[FieldQParserPlugin].
