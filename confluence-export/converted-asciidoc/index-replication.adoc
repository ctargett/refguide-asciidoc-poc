...
image:attachments/32604221/32702467.png[image,width=159,height=235] _A Solr index can be replicated across multiple slave servers, which then process requests._
