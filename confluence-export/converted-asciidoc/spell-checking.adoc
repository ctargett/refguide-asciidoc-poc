...
|link:#SpellChecking-Thespellcheck.collateExtendedResultsParameter[spellcheck.collateExtendedResults] |If true, returns an expanded response detailing the collations found. If `spellcheck.collate` is false, this parameter will be ignored.
