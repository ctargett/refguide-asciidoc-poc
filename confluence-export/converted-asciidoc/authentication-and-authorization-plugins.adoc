...
* link:basic-authentication-plugin.html[Basic authentication]: SolrCloud only.
* link:kerberos-authentication-plugin.html[Kerberos authentication]: SolrCloud or standalone mode.
* link:rule-based-authorization-plugin.html[Rule-based authorization]: SolrCloud only.
