...
* link:#PhoneticMatching-Beider-MorsePhoneticMatching(BMPM)[Beider-Morse Phonetic Matching (BMPM)]
* link:#PhoneticMatching-Daitch-MokotoffSoundex[Daitch-Mokotoff Soundex]
* link:#PhoneticMatching-DoubleMetaphone[Double Metaphone]
* link:#PhoneticMatching-Metaphone[Metaphone]
* link:#PhoneticMatching-Soundex[Soundex]
* link:#PhoneticMatching-RefinedSoundex[Refined Soundex]
* link:#PhoneticMatching-Caverphone[Caverphone]
* link:#PhoneticMatching-KölnerPhonetika.k.a.ColognePhonetic[Kölner Phonetik a.k.a. Cologne Phonetic]
* link:#PhoneticMatching-NYSIIS[NYSIIS]
