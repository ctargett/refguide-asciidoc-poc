...
`/schema`: <<#SchemaAPI-RetrievetheEntireSchema,retrieve>> the schema, or link:REL_LINK//#SchemaAPI-ModifytheSchema[modify] the schema to add, remove, or replace fields, dynamic fields, copy fields, or field types `/schema/fields`: link:REL_LINK//#SchemaAPI-ListFields[retrieve information] about all defined fields or a specific named field `/schema/dynamicfields`: link:REL_LINK//#SchemaAPI-ListDynamicFields[retrieve information] about all dynamic field rules or a specific named dynamic rule `/schema/fieldtypes`: link:REL_LINK//#SchemaAPI-ListFieldTypes[retrieve information] about all field types or a specific field type `/schema/copyfields`: link:REL_LINK//#SchemaAPI-ListCopyFields[retrieve information] about copy fields `/schema/name`: link:REL_LINK//#SchemaAPI-ShowSchemaName[retrieve] the schema name `/schema/version`: link:REL_LINK//#SchemaAPI-ShowtheSchemaVersion[retrieve] the schema version `/schema/uniquekey`: link:REL_LINK//#SchemaAPI-ListUniqueKey[retrieve] the defined uniqueKey `/schema/similarity`: link:REL_LINK//#SchemaAPI-ShowGlobalSimilarity[retrieve] the global similarity definition `/schema/solrqueryparser/defaultoperator`: link:REL_LINK//#SchemaAPI-GettheDefaultQueryOperator[retrieve] the default operator
