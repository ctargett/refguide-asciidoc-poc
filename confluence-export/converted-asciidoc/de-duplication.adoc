...
The `SignatureUpdateProcessorFactory` has to be registered in `solrconfig.xml` as part of an link:update-request-processors.html[Update Request Processor Chain], as in this example:
