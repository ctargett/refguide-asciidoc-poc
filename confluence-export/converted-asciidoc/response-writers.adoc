...
|geojson |link:#ResponseWriters-GeoJSONResponseWriter[GeoJSONResponseWriter]
...
See link:velocity-response-writer.html[Velocity Response Writer] section for details.
