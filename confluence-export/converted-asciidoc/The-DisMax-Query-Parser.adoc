...
|link:#TheDisMaxQueryParser-TheqParameter[q] |Defines the raw input strings for the query.
|link:#TheDisMaxQueryParser-Theq.altParameter[q.alt] |Calls the standard query parser and defines query input strings, when the q parameter is not used.
|link:#TheDisMaxQueryParser-Theqf(QueryFields)Parameter[qf] |Query Fields: specifies the fields in the index on which to perform the query. If absent, defaults to `df`.
|link:#TheDisMaxQueryParser-Themm(MinimumShouldMatch)Parameter[mm] |Minimum "Should" Match: specifies a minimum number of clauses that must match in a query. If no 'mm' parameter is specified in the query, or as a default in `solrconfig.xml`, the effective value of the `q.op` parameter (either in the query, as a default in `solrconfig.xml`, or from the 'defaultOperator' option in `schema.xml`) is used to influence the behavior. If `q.op` is effectively AND'ed, then mm=100%; if `q.op` is OR'ed, then mm=1. Users who want to force the legacy behavior should set a default value for the 'mm' parameter in their `solrconfig.xml` file. Users should add this as a configured default for their request handlers. This parameter tolerates miscellaneous white spaces in expressions (e.g., `" 3 < -25% 10 < -3\n", " \n-25%\n ", " \n3\n "`).
|link:#TheDisMaxQueryParser-Thepf(PhraseFields)Parameter[pf] |Phrase Fields: boosts the score of documents in cases where all of the terms in the q parameter appear in close proximity.
|link:#TheDisMaxQueryParser-Theps(PhraseSlop)Parameter[ps] |Phrase Slop: specifies the number of positions two terms can be apart in order to match the specified phrase.
|link:#TheDisMaxQueryParser-Theqs(QueryPhraseSlop)Parameter[qs] |Query Phrase Slop: specifies the number of positions two terms can be apart in order to match the specified phrase. Used specifically with the `qf` parameter.
|link:#TheDisMaxQueryParser-Thetie(TieBreaker)Parameter[tie] |Tie Breaker: specifies a float value (which should be something much less than 1) to use as tiebreaker in DisMax queries.
|link:#TheDisMaxQueryParser-Thebq(BoostQuery)Parameter[bq] |Boost Query: specifies a factor by which a term or phrase should be "boosted" in importance when considering a match.
|link:#TheDisMaxQueryParser-Thebf(BoostFunctions)Parameter[bf] |Boost Functions: specifies functions to be applied to boosts. (See for details about function queries.)
|=================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================================
