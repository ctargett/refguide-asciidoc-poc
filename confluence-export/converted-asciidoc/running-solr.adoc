...
Running the `cloud` example starts Solr in <<solrcloud.adoc,SolrCloud>> mode. For more information on starting Solr in cloud mode, see the section link:REL_LINK//getting-started-with-solrcloud.adoc[Getting Started with SolrCloud].
