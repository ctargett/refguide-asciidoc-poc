...
* link:#LanguageAnalysis-RelatedTopics[Related Topics]
...
`strength`: Valid values are `primary`, `secondary`, `tertiary` or `identical`. See http://docs.oracle.com/javase/7/docs/api/java/text/Collator.html[Oracle Java 7 Collator javadocs] for more information.

`decomposition`: Valid values are `no`, `canonical`, or `full`. See http://docs.oracle.com/javase/7/docs/api/java/text/Collator.html[Oracle Java 7 Collator javadocs] for more information.
...
* link:#LanguageAnalysis-Arabic[Arabic]
* link:#LanguageAnalysis-BrazilianPortuguese[Brazilian Portuguese]
* link:#LanguageAnalysis-Bulgarian[Bulgarian]
* link:#LanguageAnalysis-Catalan[Catalan]
* link:#LanguageAnalysis-Chinese[Chinese]
* link:#LanguageAnalysis-SimplifiedChinese[Simplified Chinese]
* link:#LanguageAnalysis-CJK[CJK]
* link:#LanguageAnalysis-Czech[Czech]
* link:#LanguageAnalysis-Danish[Danish]

* link:#LanguageAnalysis-Dutch[Dutch]
* link:#LanguageAnalysis-Finnish[Finnish]
* link:#LanguageAnalysis-French[French]
* link:#LanguageAnalysis-Galician[Galician]
* link:#LanguageAnalysis-German[German]
* link:#LanguageAnalysis-Greek[Greek]
* link:#LanguageAnalysis-Hebrew,Lao,Myanmar,Khmer[Hebrew, Lao, Myanmar, Khmer]
* link:#LanguageAnalysis-Hindi[Hindi]

* link:#LanguageAnalysis-Indonesian[Indonesian]
* link:#LanguageAnalysis-Italian[Italian]
* link:#LanguageAnalysis-Irish[Irish]
* link:#LanguageAnalysis-Japanese[Japanese]
* link:#LanguageAnalysis-Latvian[Latvian]
* link:#LanguageAnalysis-Norwegian[Norwegian]
* link:#LanguageAnalysis-Persian[Persian]
* link:#LanguageAnalysis-Polish[Polish]
* link:#LanguageAnalysis-Portuguese[Portuguese]

* link:#LanguageAnalysis-Romanian[Romanian]
* link:#LanguageAnalysis-Russian[Russian]
* link:#LanguageAnalysis-Scandinavian[Scandinavian]
* link:#LanguageAnalysis-Serbian[Serbian]
* link:#LanguageAnalysis-Spanish[Spanish]
* link:#LanguageAnalysis-Swedish[Swedish]
* link:#LanguageAnalysis-Thai[Thai]
* link:#LanguageAnalysis-Turkish[Turkish]
