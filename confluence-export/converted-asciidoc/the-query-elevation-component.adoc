...
The `[elevated]` link:transforming-result-documents.html[Document Transformer] can be used to annotate each document with information about whether or not it was elevated:
