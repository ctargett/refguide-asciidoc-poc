...
* Schema based per-fieldtype configuration for `docValuesFormat` and `postingsFormat` - see the link:field-type-definitions-and-properties.html#FieldTypeDefinitionsandProperties-GeneralProperties[Field Type Definitions and Properties] section for more details.
