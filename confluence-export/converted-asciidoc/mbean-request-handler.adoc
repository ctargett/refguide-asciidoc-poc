...
The MBean Request Handler offers programmatic access to the information provided on the link:plugins-stats-screen.html[Plugin/Stats] page of the Admin UI.
