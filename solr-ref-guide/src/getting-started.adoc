...
<<solr-start-script-reference.adoc#solr-start-script-reference,Solr Start Script Reference>>: a complete reference of all of the commands and options available with the bin/solr script.
