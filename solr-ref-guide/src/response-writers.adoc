...
Solr also includes a Response Writer that outputs binary format for use with a Java client. See <<client-apis.adoc#client-apis,Client APIs>> for more details.
